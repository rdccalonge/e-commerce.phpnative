...
<td><input type="file" name="product_image" required/><img src="product_images/<?php echo $pro_image; ?>" width="60" height="60"/></td>
</tr>
<tr>
...
<td><textarea name="product_desc" cols="40" rows="10"><?php echo $pro_desc;?></textarea></td>
</tr>
<tr>
...
if(isset($_POST['update_product'])){
	...
	$product_title = mysql_escape_string($_POST['product_title']);
	$product_cat= $_POST['product_cat'];
	$product_brand = $_POST['product_brand'];
	$product_price = $_POST['product_price'];
	$product_desc = mysql_escape_string($_POST['product_desc']);
