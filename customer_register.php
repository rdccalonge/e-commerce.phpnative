...
<div class="main_wrapper">
 ...
 <a href="index.php"><img src="images/header.jpg" /></a>
     ...
     <ul id="menu">
        ...
        <input type="text"  style="width:200;height:42;font-size: 13; " name="user_query" placeholder="Search a Product"/ >
  ...
  <div class="content_wrapper">
		 ...
		 Total Items: <?php total_items() ;?>  Total Price: <?php total_price() ;?> <a href="cart.php" style="color:red">Go To Cart</a>
		 </span>
		 </div>
